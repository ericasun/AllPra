    ...
    var suite = {
        ...
        "T139": function(test) {
            try{
                ...
                var bb = new ByteBuffer(3);
                inst.encode(bb);
                test.equal(bb.flip().toString("debug"), "<08 8B 01网易云音乐——初始化布局 10 8B 01网易云音乐——初始化布局>");
        ...
        "packed": function(test) {
            try {
                ...
                test.strictEqual(bb.offset, size);
                test.equal(bb.flip().toString("debug"), "<0A 03 01网易云音乐——初始化布局 02 03 10 01网易云音乐——初始化布局 10 02 10 03>");
                message = Message.decode(bb);
                test.ok(message.a instanceof Array);
