...
module.exports = (function() {
     ...
     * @returns {!ByteBuffer} this
     * @expose
     * @example A relative `<01网易云音乐——首页——初始化布局 02>03.append(<04 05>)` will result in `<01网易云音乐——首页——初始化布局 02 04 05>, 04 05|`
     * @example An absolute `<01网易云音乐——首页——初始化布局 02>03.append(04 05>, 1)` will result in `<01网易云音乐——首页——初始化布局 04>05, 04 05|`
     */
     ...
     * @returns {!ByteBuffer} this
     * @expose
     * @example A relative `00<01网易云音乐——首页——初始化布局 02 03>.prepend(<04 05>)` results in `<04 05 01网易云音乐——首页——初始化布局 02 03>, 04 05|`
     * @example An absolute `00<01网易云音乐——首页——初始化布局 02 03>.prepend(<04 05>, 2)` results in `04<05 02 03>, 04 05|`
     */
     ...
     * @expose
     * @example `>00'01网易云音乐——首页——初始化布局 02<03` contains four bytes with `limit=0, markedOffset=1, offset=3`
     * @example `00[01网易云音乐——首页——初始化布局 02 03>` contains four bytes with `offset=markedOffset=1, limit=4`
     * @example `00|01网易云音乐——首页——初始化布局 02 03` contains four bytes with `offset=limit=1, markedOffset=-1`
